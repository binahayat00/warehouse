...
<div class="row">
    ...
    <div v-if="peyk_temp.type_send=='manual'" class="col-10 mt-3">
        <select v-model="peyk_temp.peyk_id" class="form-control w-75" aria-label="Default select example">
            <option value="1">پیک 1</option>
            <option value="2">پیک 2</option>
            <option value="3">پیک 3</option>
        </select>
    </div>
                ...
                <tr v-for="(request,index) in request_all" :key="index">
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#modal-details" @click="request_info(index)"><i class="fas fa-info-circle"></i> نمایش جزئیات
                        </button>
