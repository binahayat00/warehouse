    ...
    <div class="p-md-5 pt-4 height-100 w-100">
        <div class="container-fluid height-100">
            ...
            <div id="store_id" class="row justify-content-center mt-5 p-3 h-100">
                ...
                <!--                   <p>برای ثبت درخواست لطفا اول انبار خود را انتخاب کنید:</p>-->
                <!--                </div>-->

                <div class="col col-md-4 list_warehouse my-box border">
                    <p class="text-center mt-3">برای ثبت درخواست لطفا اول انبار خود را انتخاب کنید:</p>
                ...
                <div class="btn_warehouse text-left">
                    <button type="button" class="btn btn-success save_warehous" @click="showProducts">ادامه</button>
                </div>
                <!--                <div class="col-md-9 col-sm-12 text-left">-->
                <!--                    <button type="button" class="btn btn-success save_warehous" @click="showProducts">ادامه</button>-->
                <!--                </div>-->

                <!--                <div class="col col-md-4 col-sm col-xl-4 border p-3 my-box">-->
                <!--                    <h6 class="mb-3">-->
                <!--                        لطفا اول انبار خود را انتخاب کنید:-->
                <!--                    </h6>-->
                <!--                    <multiselect v-model="warehouses"-->
                <!--                                 :options="warehouse_array"-->
                <!--                                 label="name" track-by="name"-->
                <!--                                 :showLabels="false" placeholder="نام انبار"-->
                <!--                                 class="store" @input="showProducts"></multiselect>-->
            ...
            <form v-if="show_form" class="height-100" name="requestForm" id="requestForm">
                ...
                <div class="col text-left">
                    <button type="button" class="btn btn-primary submit" @click="checkValidation">ارسال</button>
                </div>
